  ...
  return (
    <div className="footer-page">
      <div className="container py-5" style={{ maxWidth: '800px', margin: '0 auto' }}>
        ...
        <p>
          Welcome to Flow108! These Terms and Conditions ("Terms") govern your access to and use of our mobile application, website, and related health and wellness services 
          operated by <strong>Flow108 Health Technologies Pvt. Ltd.</strong> ("we," "us," or "our"). 
        ...
        <p>
          By downloading, installing, or using the Flow108 application or website, you acknowledge that you have read, understood, 
          and agree to comply with these Terms and our Privacy Policy. If you do not agree, please discontinue use immediately.
        </p>
        ...
        <p>
          We strive to provide accurate and reliable health information; however, Flow108 does not guarantee the accuracy, completeness, or reliability 
          of any data, insights, or recommendations generated within the app. You acknowledge that any actions taken based on app content are done at your own risk. 
          Flow108 shall not be held liable for any direct, indirect, or consequential damages resulting from your use of the app.
        </p>

        <h4>7. Health Disclaimer</h4>
        <p>
          The information provided in Flow108 is for general wellness and educational purposes only and should not be considered medical advice. 
          Always consult a qualified healthcare professional before making any health-related decisions.
        </p>

        <h4>8. Third-Party Links and Integrations</h4>
        <p>
          The Flow108 app or website may contain links to third-party websites or integrate third-party tools or APIs (e.g., Razorpay for payments). 
          These links are provided for convenience only, and we are not responsible for the content, accuracy, or policies of external sites or services.
        </p>
        ...
        <p style={{ marginTop: '20px', fontStyle: 'italic' }}>
          ...
          Razorpay or any third-party service provider shall not be responsible for any claims or liabilities arising 
          from the merchant’s non-adherence to these terms.
        </p>
      </div>
    </div>
  )
