...
export default function ExercisePage() {
  ...
  const handleNewStepChange = (index, field, value) => {
    ...
    updatedSteps[index][field] =
      field === "Duration" || field === "Order" ? parseInt(value) : value;
    setNewSteps(updatedSteps);
  };
  const handleDeleteNewStep = (index) => {
    const updatedSteps = [...newSteps];
    updatedSteps.splice(index, 1);
    setNewSteps(updatedSteps);
  };
  const handleDeleteEditableStep = (index) => {
 ...
 const fetchWorkouts = async () => {
  try {
    const response = await fetch(
      "https://flow108.coinagesoft.com/api/AdminWorkout/all"
    );
    if (!response.ok) throw new Error("Failed to fetch workouts");
    const data = await response.json();

    // API returns { Status, Message, Data, ... }
    setWorkouts(data.Data || []);  // ✅ Use Data property
    setLoading(false);
  } catch (err) {
  ...
  const handleAddWorkout = async (e) => {
    ...
    const newWorkout = {
      ...
      ImageUrl:
        ...
        "https://example.com/images/default-workout.png",
      Steps: newSteps,
    };

    try {
      const response = await fetch(
        "https://flow108.coinagesoft.com/api/AdminWorkout",
        {
          method: "POST",
          headers: {
  ...
  const handleAssignUsers = async (e) => {
    ...
    try {
      const response = await fetch(
        "https://flow108.coinagesoft.com/api/AdminWorkout/assign-users",
        {
          method: "POST",
          headers: {
            "Content-Type": "application/json",
        ...
        <div className="container-xxl flex-grow-1 container-p-y">
              ...
              <div className="card card-border-shadow-warning h-100">
                <div className="card-body">
                  <div className="d-flex align-items-center mb-2">
                    ...
                    <h4 className="mb-0">
                      {
                        workouts.filter((w) => w.Steps && w.Steps.length > 0)
                          .length
                      }
                    </h4>
                  </div>
              ...
              <div className="card card-border-shadow-danger h-100">
                <div className="card-body">
                  <div className="d-flex align-items-center mb-2">
                    ...
                    <h4 className="mb-0">
                      {workouts.filter((w) => w.Duration > 30).length}
                    </h4>
                  </div>
              ...
              <div className="card card-border-shadow-info h-100">
                <div className="card-body">
                  <div className="d-flex align-items-center mb-2">
                    ...
                    <h4 className="mb-0">
                      {workouts.filter((w) => w.Intensity === "High").length}
                    </h4>
                  </div>
          ...
          <div className="bs-stepper-content rounded-0">
            ...
            <div id="checkout-cart" className="content">
              <div className="row">
                {/* <!-- Cart left --> */}
                <div className="col-xl-8 mb-4 mb-xl-0"></div>
              </div>
            </div>
                  ...
                  <ul className="list-group">
                    {paginatedWorkouts.map((workout) => (
                      <li
                        ...
                        className="list-group-item p-5"
                      >
                        <div className="d-flex gap-4">
                          <div className="flex-shrink-0">
                            <a
                              href={`/WorkoutDetails?workoutId=${workout.WorkoutId}`}
                            >
                              <img
                                src={
                                  workout.ImageUrl ||
                                ...
                                <div className="text-md-end">
                                  <div className="my-2 my-lg-6 d-flex gap-2">
                                    <button
                                      ...
                                      onClick={() =>
                                        setAssignWorkoutId(workout.WorkoutId)
                                      }
                                    >
                    ...
                    <form id="exerciseForm" onSubmit={handleAddWorkout}>
                      ...
                      <div className="mb-3">
                        ...
                        <textarea
                          ...
                          name="features"
                          rows="3"
                          placeholder="e.g. A comprehensive workout plan for beginners"
                          required
                        ></textarea>
                      </div>
                          ...
                          <div key={index} className="row mb-3 align-items-end">
                            ...
                            <div className="col-md-1">
                              <button
                                ...
                                onClick={() => handleDeleteNewStep(index)}
                              >
                                <i className="ri-delete-bin-line"></i>
                              </button>
                            </div>
            ...
            <div className="modal-content rounded-3 shadow">
              ...
              <div className="modal-body">
                <form id="editPlanForm" onSubmit={handleEditWorkout}>
                  ...
                  <div className="row">
                    <div className="col-md-6 mb-3">
                      <label htmlFor="editIntensity" className="form-label">
                        Intensity *
                      </label>
                      <select
                        className="form-select"
                      ...
                      >
                        ...
                        <div className="col-md-2">
                          ...
                          <input
                            ...
                            value={step.Order}
                            onChange={(e) =>
                              handleStepChange(index, "Order", e.target.value)
                            }
                          />
                        </div>
                        <div className="col-md-1">
                          <button
                            type="button"
                            className="btn btn-sm btn-danger mt-4"
                            onClick={() => handleDeleteEditableStep(index)}
                          >
                            <i className="ri-delete-bin-line"></i>
                          </button>
                        </div>
